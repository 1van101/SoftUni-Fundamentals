from test.food_orders_app import FoodOrdersApp
from test.meals.starter import Starter
from test.meals.dessert import Dessert
from test.meals.main_dish import MainDish
