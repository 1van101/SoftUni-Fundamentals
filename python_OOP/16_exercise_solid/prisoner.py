...
print(f"The location of the prison: ({', '.join(str(x) for x in prisoner.PRISON_LOCATION)})")
print(f"The current position of the prisoner: ({', '.join(str(x) for x in prisoner.position)})")
